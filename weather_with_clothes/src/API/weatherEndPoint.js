...
export const MID_TERM_TEMP_END_POINT = "https://apis.data.go.kr/1360000/MidFcstInfoService/getMidTa?";

// 조회조건(지점 번호, 시간)으로 종관기상관측일자료 데이터(지점 번호, 온도, 습도 등)를 조회하는 기능
export const DAILY_FORCAST_END_POINT = "https://apis.data.go.kr/1360000/AsosDalyInfoService/getWthrDataList?";
...
// 이걸로는 오늘 날씨 기온(TMP), 비 구름(SKY), 강수확률(POP) 나타내면 될듯
export const WEEK_LAND_FORCAST_END_POINT = "https://apis.data.go.kr/1360000/MidFcstInfoService/getMidLandFcst?";

// 중기전망조회
export const WEEK_SUMMARY_END_POINT = "https://apis.data.go.kr/1360000/MidFcstInfoService/getMidFcst?";
